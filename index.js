...
// const superbowlWin = element => {
//     const match = (element.result === "W");
//     return match
// }

Works
function superbowlWin(array) {
    const match = array.find(array => array.result === "W")
...
// will return the first W
// Why do I just need the array here, instead of element, index, and array?
// why does array.result work?
// I know that the .find method iterates through each element in the array. 
// Within each element of the array, there's an object.
// Record is passed in to the callback function using record.find
// At index 0, access object key using array.result, little confused. 


/// OHHHHH, have to use the .find in the function itself. 
